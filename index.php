...
<main>
  <div class="carousel-container">
    <div id="demo" class="carousel slide carousel-fade fixed-controls-carousel" data-ride="carousel" data-interval="5000">
      ...
      <div class="carousel-caption justify-content-center align-items-center" title="carousel image">
        <h1 class="text-light"><b>Tradeflow Capital Management</b></h1>
  ...
  <div id="bodytext">
    <div class="container">
      <!-- Combined Text and Image Row -->
      <div class="row justify-content-center text-image-row">
        <div class="col-md-4 col-sm-6 col-12 text-center item">
          <h1 class="Topics text-dark">Real-Time Tracking</h1>
          <div class="details">
            <p>Provide live updates on port schedules and cargo statuses.</p>
          </div>
          <div class="img1">
            <a href="Whatwedo.php"><img src="../img/ship1.jpg" class="img-fluid fixed-height-img" alt="responsive image"></a>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 col-12 text-center item">
          ...
          <div class="img1">
            <a href="Whatwedo.php"><img src="../img/shipping.jpg" class="img-fluid fixed-height-img" alt="responsive image"></a>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 col-12 text-center item">
          ...
          <div class="img1">
            <a href="Whatwedo.php"><img src="../img/ship2.jpg" class="img-fluid fixed-height-img" alt="responsive image"></a>
          </div>
        </div>
      </div>
    </div>
